"""
Example: How to call the findajob-dwp-gov-uk-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/findajob-dwp-gov-uk-scraper
...
def run_actor():
    """Run the findajob-dwp-gov-uk-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/findajob-dwp-gov-uk-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://findajob.dwp.gov.uk/search?q=&w="}],
            "maxItems": 10,
        }
    )
